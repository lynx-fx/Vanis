  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `${VITE_HOST}/api/file/getFile?file=${downloadCode}`,
        {
          method: "GET",
        }
      );
      ...
      if (response.ok && data.success) {
        const file = data.existingFile;
        setFileInfo({
          id: file._id,
          name: file.fileName,
          size: file.size,
          uploadDate: new Date(file.createdAt),
          expiresAt: new Date(file.lifeSpan),
          type: file.fileType,
        });
        setDownloaded(false);
      }
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-400">
                      ...
                      <div>
                        ...
                        {fileInfo.uploadDate.toLocaleDateString()}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-2 p-3 bg-gray-800 border border-gray-600 rounded-lg mb-6">
                  ...
                  <div className="text-sm">
                    ...
                    <span className="text-white font-medium">
                      {getTimeRemaining(fileInfo.expiresAt)}
                    </span>
                  </div>
                </div>
                ...
                <div className="mt-6 p-4 bg-gray-800 border border-gray-600 rounded-lg">
                  <div className="flex items-start space-x-2">
                    ...
                    <div className="text-xs text-gray-400">
                      ...
                      <p>
                        This file will be automatically deleted after
                        expiration. Downloads are limited and tracked for
                        security purposes.
                      </p>
                    </div>
                  </div>
