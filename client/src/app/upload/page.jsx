    ...
    <main className="min-h-screen bg-black">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">Secure File Upload</h1>
          <p className="text-gray-400 text-sm md:text-base max-w-2xl mx-auto">
            Share files anonymously and securely. Files are automatically deleted after 24 hours.
          </p>
        </div>
        ...
        <div className="mb-8 bg-gray-800 border border-gray-700 rounded-lg shadow-lg">
          <div className="p-6">
            ...
            >
              ...
              <p className="text-lg font-medium text-gray-200 mb-2">Drag and drop files here</p>
            ...
            {files.length > 0 && (
              <div className="mt-6">
                <h3 className="font-medium text-white mb-3">Selected Files ({files.length})</h3>
